...
from sagemaker_pytorch_serving_container.transformer import PTTransformer
...
class HandlerService(DefaultHandlerService):
    ...
    def __init__(self):
        ...
        transformer = PTTransformer(default_inference_handler=DefaultPytorchInferenceHandler())
