...
from sagemaker_pytorch_serving_container.default_inference_handler import DefaultModuleInferenceHandler


class PyTorchModuleTransformer(Transformer):
    ...
    """
    def __init__(self):
        super(PyTorchModuleTransformer, self).__init__(DefaultModuleInferenceHandler())
