...
from integration import mnist_inductor_tar, mnist_inductor_script
...
def test_mnist_cpu_inductor(sagemaker_session, image_uri, instance_type):
    ...
    _test_mnist_distributed(sagemaker_session, image_uri, instance_type, mnist_inductor_tar, mnist_inductor_script)
...
def _test_mnist_distributed(sagemaker_session, image_uri, instance_type, model_tar, mnist_script, env_vars=None):
